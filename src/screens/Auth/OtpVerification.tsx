...
import { setLogin, setProfilePic, setToken, setUser, setUserEmail } from '../../redux/slice/roleSlice';
...
const OtpVerification = ({ route }) => {
  ...
  const handleSubmitOtp = async (text: any) => {
    ...
    if (response?.data.response.data) {
      ...
      console.log("Email from response: ", response.data.response.data.user.email);
